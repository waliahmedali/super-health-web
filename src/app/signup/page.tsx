          ...
          <div className="mt-5 rounded-2xl border border-gray-200 bg-[#fafafa] p-3">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                <p className="flex min-w-0 items-baseline gap-2 text-[14px] font-semibold leading-tight text-ink sm:text-[16px]">
                  <span className="min-w-0 flex-1 truncate">Standard Therapeutics Membership</span>
